...
List<BankingCardModel> bankingCardList() {
  ...
  var list1 =
      BankingCardModel(name: "Ndegwa Jay", bank: "The Same Bank", rs: "12,500");
  list.add(list1);

  var list2 =
      BankingCardModel(name: "Adama Wesonga", bank: "Union Bank", rs: "18,000");
  list.add(list2);

  var list3 = BankingCardModel(
      name: "Ana Aoko", bank: "Unitied States Bank", rs: "50,000");
  list.add(list3);
...
List<BankingHomeModel> bankingHomeList1() {
  ...
  var list2 = BankingHomeModel(
      title: "Kamau   Johnson", color: Banking_Primary, bal: "-\$20 USD");
  list.add(list2);
