        ...
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
          return [
            SliverAppBar(
              ...
              backgroundColor:
                  innerBoxIsScrolled ? Banking_Primary : context.cardColor,
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "Hello,Laura",
                          style:
                              primaryTextStyle(color: Banking_TextColorWhite),
                        ),
                        Text(
                          "How are you today?",
                          style:
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.account_balance_wallet,
                              size: 24, color: mList1[index].color),
                          10.width,
                          Text(
                            '${mList1[index].title}',
                    ...
                    return Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(data.charge!,
                              style:
                                  primaryTextStyle(color: data.color, size: 16))
                        ],
                      ),
                    );
                  },
