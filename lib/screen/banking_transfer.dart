            ...
            children: [
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: boldTextStyle(
                                ...
                                top: spacing_large, right: spacing_standard_new)
                          ],
                        ),
                        Text(
                          "The Same Bank",
                        ...
                        Text(
                          ...
                          style: boldTextStyle(
                            ...
                            left: spacing_standard_new, top: spacing_control),
                        Text(
                          "\$" + "12,500",
                          style: boldTextStyle(
                              color: Banking_whitePureColor,
                            ...
                            top: spacing_standard, left: spacing_standard_new),
                      ],
                    ),
                    10.height,
                  ],
              ...
              Column(
                ...
                children: [
                  ...
                  Text("Transfer Info",
                      style:
                          primaryTextStyle(color: Banking_TextColorSecondary)),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Amount",
    ...
    child: Column(
      ...
      children: [
        ...
        Text(Banking_lbl_Other_Bank,
                style: primaryTextStyle(
                    color: Banking_TextColorSecondary, size: 16))
            .onTap(() {
          finish(context);
        }),
        8.height,
